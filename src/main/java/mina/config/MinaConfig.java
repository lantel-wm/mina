...
public record MinaConfig(
        ...
        int interactableScanRadius,
        int interactableScanVerticalRange,
        int interactableScanIntervalTicks,
        int longDangerThresholdTicks,
        String observationLanguage,
    ...
    public static MinaConfig load() {
        ...
        return new MinaConfig(
                ...
                readInt("MINA_ENTITY_SCAN_RADIUS", "mina.entity_scan_radius", properties, 24),
                readInt("MINA_ENTITY_SCAN_LIMIT", "mina.entity_scan_limit", properties, 32),
                readInt("MINA_ENTITY_SCAN_INTERVAL_TICKS", "mina.entity_scan_interval_ticks", properties, 20),
                readInt("MINA_INTERACTABLE_SCAN_RADIUS", "mina.interactable_scan_radius", properties, 12),
                readInt("MINA_INTERACTABLE_SCAN_VERTICAL_RANGE", "mina.interactable_scan_vertical_range", properties, 4),
                readInt("MINA_INTERACTABLE_SCAN_INTERVAL_TICKS", "mina.interactable_scan_interval_ticks", properties, 40),
                readInt("MINA_LONG_DANGER_THRESHOLD_TICKS", "mina.long_danger_threshold_ticks", properties, 200),
                readString("MINA_OBSERVATION_LANGUAGE", "mina.observation.language", properties, "en_us"),
